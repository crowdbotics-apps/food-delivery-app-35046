...
## Project Structure
    ...
    ├── food_delivery_app_35046  # Django project configurations
...
1. Clone this repo and `cd food_delivery_app_35046`
...
2. Clone this repo and `cd food_delivery_app_35046`
